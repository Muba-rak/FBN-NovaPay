  ...
  ({ transaction, onSelect }) => {
    ...
    return (
      <div
        ...
        className="group flex w-full items-center justify-between rounded-xl border border-slate-200/70 bg-white p-3 sm:p-3.5 text-left shadow-xs transition-all duration-150 hover:border-slate-300 hover:bg-slate-50/90 hover:shadow-sm focus-visible:border-amber-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-400/40 dark:border-slate-800/80 dark:bg-[#112240] dark:hover:border-slate-700 dark:hover:bg-[#152a4e] cursor-pointer"
      >
